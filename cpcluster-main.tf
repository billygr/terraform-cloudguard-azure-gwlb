...
data "azurerm_subnet" "frontend" {
  ...
  virtual_network_name = azurerm_virtual_network.vnet-south.name
  resource_group_name = azurerm_virtual_network.vnet-south.resource_group_name
}
...
resource "random_id" "clusterrandomId" {
  keepers = {
